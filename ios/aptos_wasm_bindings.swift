...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeRangeProof: FfiConverter {

    typealias FfiType = UnsafeMutableRawPointer
    typealias SwiftType = RangeProof

    public static func lift(_ pointer: UnsafeMutableRawPointer) throws -> RangeProof {
        return RangeProof(unsafeFromRawPointer: pointer)
    }

    public static func lower(_ value: RangeProof) -> UnsafeMutableRawPointer {
        return value.uniffiClonePointer()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RangeProof {
    ...
    public static func write(_ value: RangeProof, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRangeProof_lift(_ pointer: UnsafeMutableRawPointer) throws -> RangeProof {
    return try FfiConverterTypeRangeProof.lift(pointer)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRangeProof_lower(_ value: RangeProof) -> UnsafeMutableRawPointer {
    return FfiConverterTypeRangeProof.lower(value)
}
