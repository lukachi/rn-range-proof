 ...
 * @suppress
 */
public object FfiConverterTypeRangeProof : FfiConverter<RangeProof, Pointer> {
    override fun lower(value: RangeProof): Pointer = value.uniffiClonePointer()

    override fun lift(value: Pointer): RangeProof = RangeProof(value)

    override fun read(buf: ByteBuffer): RangeProof {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: RangeProof) = 8UL
...
public object FfiConverterTypeMyError : FfiConverterRustBuffer<MyException> {
    ...
    override fun allocationSize(value: MyException): ULong = 4UL
    ...
    override fun write(
        ...
        when (value) {
            is MyException.MissingInput -> {
                buf.putInt(1)
                Unit
            }
            is MyException.IndexOutOfBounds -> {
                buf.putInt(2)
                Unit
            }
